...
class HeaderItemDecoration(
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        for(index in 0..4) {
            ...
            val topChild: View = parent.getChildAt(index)
/*            if (topChild == null) {
                return
            }*/
...
/*            if (topChildPosition == RecyclerView.NO_POSITION) {
            ...
            moveHeader(c, currentHeader, childInContact, topChild.top.toFloat(), topChild.left.toFloat())
//            if (mListener.isHeader(parent.getChildAdapterPosition(childInContact))) {
//                moveHeader(c, currentHeader, childInContact, topChild.top.toFloat(), topChild.left.toFloat())
//                //return
//            } else
//            drawHeader(c, currentHeader, topChild.top.toFloat(), topChild.left.toFloat())
        }
    }
    ...
    private fun drawHeader(c: Canvas, header: View, top: Float, left: Float) {
        Log.d("TEST", "drawHeader($top, $left)")
        c.save()
    ...
    private fun moveHeader(c: Canvas, currentHeader: View, nextHeader: View, top: Float, left: Float) {
        Log.d("TEST", "moveHeader()")
        c.save()
        c.translate(0f/*(nextHeader.left - currentHeader.width).toFloat()*/, 0f/*(nextHeader.top - currentHeader.height).toFloat()*/)
    ...
    interface StickyHeaderInterface {
        ...
        /**
         * This method gets called by [HeaderItemDecoration] to get layout resource id for the header item at specified adapter position.
